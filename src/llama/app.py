...
os.environ['HF_TOKEN'] = "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"
...
instruction = "How are you feeling for today? Are you happy, neutral or sad? Anyone in particular you saw that excites you"
input = "I feel happy. I got to see my dog, who is my best friend."
...
[
    alpaca_prompt.format(
        instruction,
        input,
        "", # output - leave it blank for generation!
    )
...
trainer = SFTTrainer(
    ...
    max_seq_length = max_seq_length,
    dataset_num_proc = 2,
    packing = False, # Could make training 5x faster for short sequences.
