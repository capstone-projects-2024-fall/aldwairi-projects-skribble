...
public class Skribble {
    ...
    public Skribble(int entryID, int userID, LocalDate dateCreated, String entry, String mood, String aiPrompt) {
    ...
    public String toString() {
        return "Skribble [entryID=" + entryID + ", userID=" + userID + ", dateCreated=" + dateCreated + ", entry="
                + entry + ", mood=" + mood + ", aiPrompt=" + aiPrompt + "]";
    }
